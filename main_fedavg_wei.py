...
def main(args):
    ...
    for v in range(len(set_variable)):
            ...
            for j in range(len(set_variable1)):
                ...
                for m in range(args.num_experiments):
                    ...
                    for iter in range(args.epochs):
                        ...
                        # ## perturb 'w_local' ###
                        w_locals = noise_add(args, noise_scale/args.offline_rate, w_locals)                        
                        ...
                        # 统一加入差分隐私
                        # w_glob = noise_add(args, noise_scale/args.offline_rate, w_glob)
        ...
        data_test_acc.to_csv('./experiresult/'+'aggregation_consuming_{}_{}_{}_{}_{}.csv'.\
...
if __name__ == '__main__':    
    ...
    # 泊松分布
    # args.set_num_Chosenusers = np.random.poisson(lam=50, size=5)
